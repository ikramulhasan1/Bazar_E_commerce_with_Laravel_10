                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row"><a href="#"><img
                                                    src="{{ asset('ui/backend') }}/assets/img/product-1.jpg"
                                                    alt=""></a>
                                        </th>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#"><img
                                                    src="{{ asset('ui/backend') }}/assets/img/product-2.jpg"
                                                    alt=""></a>
                                        </th>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#"><img
                                                    src="{{ asset('ui/backend') }}/assets/img/product-3.jpg"
                                                    alt=""></a>
                                        </th>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#"><img
                                                    src="{{ asset('ui/backend') }}/assets/img/product-4.jpg"
                                                    alt=""></a>
                                        </th>
                                    ...
                                    <tr>
                                        <th scope="row"><a href="#"><img
                                                    src="{{ asset('ui/backend') }}/assets/img/product-5.jpg"
                                                    alt=""></a>
                                        </th>
                ...
                <div class="card-body pb-0">
                    ...
                    <div class="news">
                        <div class="post-item clearfix">
                            <img src="{{ asset('ui/backend') }}/assets/img/news-1.jpg" alt="">
                        ...
                        <div class="post-item clearfix">
                            <img src="{{ asset('ui/backend') }}/assets/img/news-2.jpg" alt="">
                        ...
                        <div class="post-item clearfix">
                            <img src="{{ asset('ui/backend') }}/assets/img/news-3.jpg" alt="">
                        ...
                        <div class="post-item clearfix">
                            <img src="{{ asset('ui/backend') }}/assets/img/news-4.jpg" alt="">
                        ...
                        <div class="post-item clearfix">
                            <img src="{{ asset('ui/backend') }}/assets/img/news-5.jpg" alt="">
